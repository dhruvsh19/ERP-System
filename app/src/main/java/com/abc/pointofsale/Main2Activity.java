...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    String  p1;
    EditText price2;
    private static String inserturl = "https://diagonal-misalineme.000webhostapp.com/show.php";
    private static String dinserturl = "https://diagonal-misalineme.000webhostapp.com/dist.php";
    private static String durl = "https://diagonal-misalineme.000webhostapp.com/dlocation.php";
    private static String wurl = "https://diagonal-misalineme.000webhostapp.com/wlocation.php";
